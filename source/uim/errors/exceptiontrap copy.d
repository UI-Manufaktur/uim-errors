...
import uim.errorss.rendererss.ConsoleExceptionRenderer;
...
class ExceptionTrap
{
     ...
     * @return uim.errorss.ExceptionRendererInterface
     */
    function renderer(Throwable $exception, $request = null) {
        ...
        if (is_string($class)) {
            ...
            /** @var class-string<uim.errorss.ExceptionRendererInterface> $class */
     ...
     *
     * @return class-string<uim.errorss.ExceptionRendererInterface>
     */
    protected string chooseRenderer() {
        /** @var class-string<uim.errorss.ExceptionRendererInterface> */
     ...
     *
     * @return uim.errorss.ErrorLoggerInterface
     */
    function logger(): ErrorLoggerInterface
    {
        /** @var class-string<uim.errorss.ErrorLoggerInterface> $class */
     ...
     *
     * @return uim.errorss.ExceptionTrap|null The global instance or null.
     */
